    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp"><br><br>
          <h3 style="color:green">DELETE ROUTES HERE</h3>
           <center><form method="post" action="deletepass.php" align="center">
                              <table style="width:50%" align="center" >
                                <tr>
                                  ...
                                  width: 300px;"required><input type="submit" name="submit" value="VIEW_PASS_DATA"style="border-radius: 70%;border: 10px solid rgba(211,211,211,0.5);height: 150px;
...
if(isset($_POST['submit']))
{
  ...
  else
  {
    ...
    <td><a href="deletepassform.php?sid=<?php echo $data['id']; ?>"><button type="button" class="btn btn-outline-danger">DELETE</button></a></td>
    </tr>
      <?php
    }
  }
