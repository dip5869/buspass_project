    ...
    <section id="services">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp"><br><br>
          <h3 style="color:green">INSERT PASS HERE</h3>
        </header>
      ...
      <div class="container">
        <div class="row">
           <div class="col-md-12 col-md-offset-6">
              <form action="addpass.php" method="post" style="background: rgba(211,211,211,0.5);">
                <fieldset>
                 <div class="form-group" align="left" style="padding:25px;">
                   <label for="route"><b>ROUTE:</b></label>
                  <input type="text" name="route" class="form-control" placeholder="enter the route" required>
                  </div></center>
                  <center><div class="form-group" align="left" style="padding:25px;">
                    <label for="fee"><b>FEE:</b></label>
                  <input type="text" name="fee" class="form-control" placeholder="enter the fee" required>
                  </div>              
                  </fieldset>
