                  ...
                  <div class="container-fluid">
                    ...
                    <hr>
                      <h3 style="color:red" align="center" class="animated shake "> <b>VIEW PASS AND VALIDITY OF YOUR PASS HERE</b></h3>
                           ...
                           <center><form method="post" action="view_taken_pass.php" align="center">
                                      <table style="width:30%" align="center" >
                                        <tr>
                                          ...
                                          width: 200px;"required><input type="submit" name="submit" value="VIEW_PASS"style="border-radius: 70%;border: 10px solid rgba(211,211,211,0.5);height: 100px;
